...
#define D_DELT  (0.01f)  // She simulation step size
#define D_BXM (0.0f)
#define D_BYM (3.0f)
#define D_BZM (0.0f)
#define D_SIGMA (10.0f)        // sigma for cold electrons
#define D_SIGMA1 (10.0f)       // sigma for cold ions
#define D_SIGMA2 (0.3f)        // sigma for hot ions
#define D_SIGMA3 (1.0f)        // sigma for hot electrons
